...
namespace Gooten.ApiClient.Api
{
    ...
    public interface IOrderstatusApi
    {
        ...
        OrderStatusUpdateResult POSTOrderstatus (string partnerBillingKey, string id, string orderStatusName);
        ...
        ApiResponse<OrderStatusUpdateResult> POSTOrderstatusWithHttpInfo (string partnerBillingKey, string id, string orderStatusName);
        ...
        System.Threading.Tasks.Task<OrderStatusUpdateResult> POSTOrderstatusAsync (string partnerBillingKey, string id, string orderStatusName);
        ...
        System.Threading.Tasks.Task<ApiResponse<OrderStatusUpdateResult>> POSTOrderstatusAsyncWithHttpInfo (string partnerBillingKey, string id, string orderStatusName);
    ...
    public class OrderstatusApi : IOrderstatusApi
    {
        ...
        /// <param name="orderStatusName">Order status name for update</param> 
        /// <returns>OrderStatusUpdateResult</returns>
        public OrderStatusUpdateResult POSTOrderstatus (string partnerBillingKey, string id, string orderStatusName)
        {
             ApiResponse<OrderStatusUpdateResult> localVarResponse = POSTOrderstatusWithHttpInfo(partnerBillingKey, id, orderStatusName);
        ...
        /// <param name="orderStatusName">Order status name for update</param> 
        /// <returns>ApiResponse of OrderStatusUpdateResult</returns>
        public ApiResponse< OrderStatusUpdateResult > POSTOrderstatusWithHttpInfo (string partnerBillingKey, string id, string orderStatusName)
        {
            
            // verify the required parameter 'partnerBillingKey' is set
            if (partnerBillingKey == null)
                throw new ApiException(400, "Missing required parameter 'partnerBillingKey' when calling OrderstatusApi->POSTOrderstatus");
        ...
        /// <param name="orderStatusName">Order status name for update</param>
        /// <returns>Task of OrderStatusUpdateResult</returns>
        public async System.Threading.Tasks.Task<OrderStatusUpdateResult> POSTOrderstatusAsync (string partnerBillingKey, string id, string orderStatusName)
        {
             ApiResponse<OrderStatusUpdateResult> localVarResponse = await POSTOrderstatusAsyncWithHttpInfo(partnerBillingKey, id, orderStatusName);
             return localVarResponse.Data;
        ...
        /// <param name="orderStatusName">Order status name for update</param>
        /// <returns>Task of ApiResponse (OrderStatusUpdateResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrderStatusUpdateResult>> POSTOrderstatusAsyncWithHttpInfo (string partnerBillingKey, string id, string orderStatusName)
        {
            // verify the required parameter 'partnerBillingKey' is set
            if (partnerBillingKey == null) throw new ApiException(400, "Missing required parameter 'partnerBillingKey' when calling POSTOrderstatus");
            // verify the required parameter 'id' is set
