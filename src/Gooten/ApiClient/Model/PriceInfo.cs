...
namespace Gooten.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PriceInfo :  IEquatable<PriceInfo>
    { 
        ...
        public PriceInfo(long? Price = null, string CurrencyCode = null, string FormattedPrice = null, string CurrencyFormat = null, long? CurrencyDigits = null)
        {
            // to ensure "Price" is required (not null)
            if (Price == null)
            {
                throw new InvalidDataException("Price is a required property for PriceInfo and cannot be null");
            }
            else
            {
                this.Price = Price;
            ...
            {
                throw new InvalidDataException("CurrencyCode is a required property for PriceInfo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FormattedPrice is a required property for PriceInfo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CurrencyFormat is a required property for PriceInfo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CurrencyDigits is a required property for PriceInfo and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PriceInfo);
        }

        /// <summary>
        /// Returns true if PriceInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of PriceInfo to be compared</param>
        /// <returns>Boolean</returns>
