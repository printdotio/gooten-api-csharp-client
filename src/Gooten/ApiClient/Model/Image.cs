...
namespace Gooten.ApiClient.Model
{
    ...
    { 
        ...
        public Image(string Url = null, long? Index = null, string ThumbnailUrl = null, string ManipCommand = null, string SpaceId = null)
        {
            ...
            if (Index == null)
            {
                throw new InvalidDataException("Index is a required property for Image and cannot be null");
            }
            else
            {
                this.Index = Index;
            ...
            {
                throw new InvalidDataException("ThumbnailUrl is a required property for Image and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ManipCommand is a required property for Image and cannot be null");
            }
            else
            {
            ...
            if (SpaceId == null)
            {
                throw new InvalidDataException("SpaceId is a required property for Image and cannot be null");
            }
            else
            {
