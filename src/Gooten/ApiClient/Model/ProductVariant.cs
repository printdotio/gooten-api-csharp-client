...
namespace Gooten.ApiClient.Model
{
    ...
    { 
        ...
        /// <param name="PartnerPriceInfo">PartnerPriceInfo.</param>

        public ProductVariant(string Sku = null, long? MaxImages = null, bool? HasTemplates = null, List<ProductOption> Options = null, ProductPriceInfo PriceInfo = null, ProductPriceInfo PartnerPriceInfo = null)
        {
            ...
            if (PriceInfo == null)
            {
                throw new InvalidDataException("PriceInfo is a required property for ProductVariant and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets PartnerPriceInfo
        /// </summary>
        [DataMember(Name="PartnerPriceInfo", EmitDefaultValue=false)]
        public ProductPriceInfo PartnerPriceInfo { get; set; }
        ...
        public bool Equals(ProductVariant other)
        {
            ...
            return 
                ...
                (
                    this.PartnerPriceInfo == other.PartnerPriceInfo ||
                    this.PartnerPriceInfo != null &&
                    this.PartnerPriceInfo.Equals(other.PartnerPriceInfo)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PartnerPriceInfo != null)
                    hash = hash * 59 + this.PartnerPriceInfo.GetHashCode();
